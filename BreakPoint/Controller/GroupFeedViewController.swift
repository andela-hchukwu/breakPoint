...
class GroupFeedViewController: UIViewController {
    ...
    @IBAction func sendBtnWasPressed(_ sender: Any) {
        if messageTextField.text != "" {
            ...
            DataService.instance.uploadPost(withMessage: messageTextField.text!, forUID: (Auth.auth().currentUser?.uid)!, withGroupKey: self.group?.key, sendComplete: { (complete) in
                if complete {
